 ...
 <div class="block">   
		...
		<el-table :data="datalist" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column label="操作" min-width="250">
                ...
                <el-button size="small" type="primary" @click="showRelationPanel(scope.$index,scope.row)">查看绑定小区</el-button>
                <el-button size="small" type="danger" @click="deleteRow(scope.$index,scope.row)">删除</el-button>
        ...
        <el-dialog   :title="formtitle" :visible.sync="dialogFormVisible" >
			<el-table :data="residRooms" highlight-current-row style="width: 100%;">
                    <el-table-column prop="communityName" label="小区" width="115" sortable>
                    </el-table-column>
                    ...
                    <el-table-column label="是否默认" width="120" sortable>
...
<script>
    ...
    methods: {
      ...
      loadRooms(){
            ...
            RequestGet("/resident/authListDetail",room).then(response => {
